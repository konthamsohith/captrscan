            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start">
                    ...
                    <div className="lg:col-span-4 pt-10 lg:pt-20 lg:pl-24">
                        ...
                        >
                            <h1 className="font-['Poppins'] font-normal text-[64px] leading-[72px] text-[rgb(21,21,21)] mb-6 tracking-tight">
                                Never lose a business card again<br />
                                <span className="text-[rgb(102,102,102)]">just scan it.</span>
                            </h1>

                            <div className="flex items-center gap-4">
                                <button className="bg-blue-50 font-['Poppins'] font-normal text-[18px] text-[rgb(0,0,238)] px-8 py-3.5 rounded-full hover:bg-blue-100 transition-colors">
                                    Start Free Trial
                                </button>
